...
class MongoFanPagePipeline(MongoPipelineABC):
    ...
    async def process_item(self, item, spider):
        ...
        hist_coll = self.db.history_test
        result_co = hist_coll.post_reactions.update_one(
        ...
        resp_co = self.db.post_test.find_one_and_update(
            {
                'post_id': post_id,
        ...
        result: UpdateResult
        result, resp = await asyncio.gather(result_co, resp_co)
